...
Módulo 1: Estructuras de datos fundamentales – Registros y conjuntos en Java 

B. TEMAS 
• Registros representados mediante clases en Java. 
• Campos de un registro y acceso mediante el operador punto (.). 
• Arreglos de registros. 
• Recorrido de arreglos de registros. 
• Conjuntos mediante HashSet. 
• Operaciones básicas: add(), contains(), remove(), clear() y size(). 
• Recorrido de conjuntos mediante for-each. 
• Aplicación de registros y conjuntos en un problema integrador. 
...
• Identificar las características de un conjunto y comprender que sus elementos son únicos. 
• Implementar un HashSet en Java para almacenar elementos sin duplicados. 
• Aplicar add(), contains(), remove(), clear() y size() en operaciones con conjuntos. 
• Recorrer un HashSet mediante un ciclo for-each. 
• Integrar registros y conjuntos en una solución orientada a una situación de la vida real. 
• Validar entradas y presentar información clara al usuario. 
